...
const Index = () => {
  ...
  <p>אני מלווה ילדים, נוער ומבוגרים בתהליכי שינוי, צמיחה וחיבור לעצמם, בשילוב כלים מעולמות ה-NLP, הפסיכולוגיה החיובית, הדמיון המודרך ויומן המסע.</p>
  
  <p>הדרך המקצועית שלי התחילה מתוך מסע אישי: רצון להבין את עצמי לעומק, לרפא כאבים, לזהות חוזקות, וליצור חיים מדויקים יותר. התהליכים שעברתי הובילו אותי לתשוקה הגדולה שלי - לעזור לאחרים לראות את האור שבתוכם, לשחרר פחדים, ולהתחבר לכוחות הפנימיים שממתינים להיחשף.</p>
  
  <p>אני מאמינה שכל אדם, בכל גיל, יכול ללמוד להקשיב לעצמו, לרפא פצעים ישנים, ולבנות מציאות של שלווה, ביטחון ואהבה.</p>
  
  <p>בקליניקה שלי אני יוצרת מרחב בטוח, חומל ומאפשר - מקום שבו אפשר להיות, להרגיש, להשתחרר ולצמוח.</p>
</div>
